...
$num=C::t('#gfarm#gfarm_lock_log')->count_all_data($str);	
$locklogInfos=C::t('#gfarm#gfarm_lock_log')->fetch_all_data($str,$start,$perpage);
foreach ($locklogInfos as $key=>$value) {
...
include template('gfarm:cp/user/locklog');
