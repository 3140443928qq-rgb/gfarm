...
$num=C::t('#gfarm#gfarm_member_signin')->count_all_data($str);	
$signInfos=C::t('#gfarm#gfarm_member_signin')->fetch_all_data($str,$start,$perpage);
...
include template('gfarm:cp/signin/signlog');
