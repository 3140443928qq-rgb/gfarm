...
$num=C::t('#gfarm#gfarm_member_daily_task')->count_all_data($str);	
$taskInfos=C::t('#gfarm#gfarm_member_daily_task')->fetch_all_data($str,$start,$perpage);
...
include template('gfarm:cp/task/dailylog');
