...
$num=C::t('#gfarm#gfarm_member_main_task')->count_all_data($str);	
$taskInfos=C::t('#gfarm#gfarm_member_main_task')->fetch_all_data($str,$start,$perpage);
...
include template('gfarm:cp/task/mainlog');
