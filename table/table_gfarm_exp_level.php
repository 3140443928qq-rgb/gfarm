...
class table_gfarm_exp_level extends discuz_table
{
	public function __construct() {

		$this->_table = 'gfarm_exp_level';
		$this->_pk    = 'id';
	...
	public function fetch_maxlevel($where=''){
		return DB::result_first('select max(level) from %t where 1 %i', array($this->_table,$where));
	}
}
