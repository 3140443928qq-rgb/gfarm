...
class table_gfarm_signin_reward extends discuz_table
{
	public function __construct() {

		$this->_table = 'gfarm_signin_reward';
		$this->_pk    = 'id';

		parent::__construct();
	}
	public function fetch_all_data($where='',$offset=0,$limit=65535){
		return DB::fetch_all('select a.*,b.* from %t a left join %t b on a.sign_id=b.id where 1 %i limit %d,%d', array($this->_table,'gfarm_signin',$where,$offset,$limit));
	}
